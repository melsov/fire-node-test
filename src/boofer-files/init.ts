...
import * as tfirebase from "./tfirebase"; // { tfirebase } from './MPlayer';
...
function EnterLobby()
{
    ...
    localPeer = new MLocalPeer(room, fbaseUser, (isServer : boolean) => {
        ...
        if(isServer && _wantListenServer && !MDetectNode.IsRunningInNode()) {
            ...
            console.log(`***WONT create a listen server`);
        }
    });
