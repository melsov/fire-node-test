...
import * as MAnimator from "./MAnimator";
import { AssetsManager, MeshAssetTask, Scene } from "babylonjs";
import * as MMultiLoader from "./MMultiLoader";
...
export class MEntiyBabListLookup
{
    ...
    {
        let aman = new MMultiLoader.MNodeWorkAroundAM(scene, MDetectNode.IsRunningInNode()); // new AssetsManager(scene);
...
{   
    ...
    static AddTask(am : AssetsManager | MMultiLoader.MNodeWorkAroundAM, babFile : MBabFile) : MeshAssetTask
    {
