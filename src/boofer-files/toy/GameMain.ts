...
export class GameMain
{
    ...
    {
        console.log(`start of gamemain constructor`);
        ...
        console.log(`end gamemain constructor`);
    }

    private camSetup()
    {
        if(MDetectNode.IsRunningInNode()) {
            console.log(`no can setup. we're running in node`);
            return; 
        }
        ...
        if(this.mapPackage.typeOfGame === TypeOfGame.Server)
