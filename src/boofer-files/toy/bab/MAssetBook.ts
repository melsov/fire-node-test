...
import { MeshAssetTask, AbstractAssetTask, Nullable, Engine, Scene, BinaryFileAssetTask, AbstractMesh, Texture, TextureAssetTask, BaseTexture, TextFileAssetTask, NullEngine } from "babylonjs";
...
import * as MMultiLoader from "../loading/MMultiLoader";
import * as MDetectNode from "../../../MDetectRunningInNode";
...
// {
    ...
    export class TextureLoader
    {
        ...
        {
            let am = new MMultiLoader.MNodeWorkAroundAM(scene, MDetectNode.IsRunningInNode()); // AssetsManager(scene);
    ...
    // iterate over a (Loadable) object. Return the values
    // stored in its fields as an array
    ...
    {
        private readonly am : MMultiLoader.MNodeWorkAroundAM; /// AssetsManager;
        ...
        constructor(
            ...
            this.am = new MMultiLoader.MNodeWorkAroundAM(scene, MDetectNode.IsRunningInNode()); // AssetsManager(scene);
        }
